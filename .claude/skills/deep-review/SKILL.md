...
Read the relevant guideline files for each detected platform BEFORE starting the review. These inform what conventions to enforce.
...
### 7. Validate API Contracts Across Platforms
...
For each platform, suggest tests following platform-specific conventions. Read the test guidelines loaded in step 3.
