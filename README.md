...
- `make add-token asset_id=c60_t0xdd2c007852fcb61d5fb5d7a0b51713f71b8436e2 -- Create `info.json` file as asset template.
- `make add-tokenlist asset_id=c60_t0xdd2c007852fcb61d5fb5d7a0b51713f71b8436e2 -- Adds a token to tokenlist.json.
- `make add-tokenlist-extended asset_id=c60_t0xdd2c007852fcb61d5fb5d7a0b51713f71b8436e2 -- Adds a token to tokenlist-extended.json.
